...
data <- as.data.frame(read_excel("/Users/christinedavis/Documents/GitHub/Rep1/LymeSerology/SerologyData_LymeArthritis.xlsx"),
                      header = TRUE)
...
data_new <- as.data.frame(read_excel("/Users/christinedavis/Documents/GitHub/Rep1/LymeSerology/Lyme_SteereBowman_Demographic.xlsx"),
                          header = FALSE)[,3:34]
